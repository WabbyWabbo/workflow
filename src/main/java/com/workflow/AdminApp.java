...
public class AdminApp {
    ...
    public static void main(String[] args) {
        ...
        if (!file.exists()) {
            FastJsonUtils.writeFile("data.json", "{\"download\":{\"list\":[],\"total\":0,\"recent\":0},\"script\":{\"list\":[],\"total\":0,\"recent\":0},\"sikuli\":{\"list\":[],\"total\":0,\"recent\":0},\"failedHandler\":{\"list\":[],\"total\":0,\"recent\":0}}");
        }
        // 如果cache文件夹不存在则创建
